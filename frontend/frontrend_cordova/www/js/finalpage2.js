$(document).ready(function(){
    ...
    document.getElementById("today_report2").src = "https://pjt4image-newbucket.s3.amazonaws.com/walk_info_image/"+rnums[0]+"/walkimage.jpg";
    //암시 map
    document.getElementById("today_map2").src = "https://pjt4image-newbucket.s3.amazonaws.com/image/3/walkimage.jpg";
    $('#today_report2').css({
        "position" : "absolute",
        "top" : "30px",
        "left" : "60px"
